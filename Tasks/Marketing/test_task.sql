...
-- Відповідь:
-- Так, 138 ідентичних рядків у таблиці installs, 3 — у таблиці cards. 
...
-- Логіка рішення:
-- Визначаю перший інсталл для кожного користувача через ROW_NUMBER.
...
-- Логіка рішення:
-- 1. Створюю CTE, де для кожного користувача перевіряю:
